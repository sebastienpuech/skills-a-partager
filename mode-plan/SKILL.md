...
| `scripts/self_eval_debate.py` · `verify_citations.py` · `_meta_eval.py` · `h8_ablation.py` · `auto_improve.py` | **(v4.0/v4.1)** self-golden-set : teste les agents LLM (replay), ancre les citations, grader-of-graders, ablation H8, boucle d'auto-amélioration | Hors run / CI / nocturne |
| `references/notes-et-historique.md` | **(v4.1)** Articulation, portabilité, limitations, historique v1.0→v4.1, exemple | À la demande |
